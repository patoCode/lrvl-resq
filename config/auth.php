...
return [
    ...
    */
    ...
    | which utilizes session storage plus the Eloquent users provider.
    |
    | All authentication guards have a users provider, which defines how the
    ...
    */
    ...
    | and the users provider that is invoked to actually retrieve users.
    |
